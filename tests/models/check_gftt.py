...
def test_gftt_3x3_1_shave():
    check_network(lambda: check_gftt(3, 1, False, False))

def test_gftt_3x3_1_shave_gray():
    check_network(lambda: check_gftt(3, 1, False, True))

def test_gftt_3x3_1_shave_blur():
    check_network(lambda: check_gftt(3, 1, True, False))

def test_gftt_3x3_1_shave_blur_gray():
    check_network(lambda: check_gftt(3, 1, True, True))
