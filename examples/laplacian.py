...
lp, xout_lp = create_neural_network(pipeline, cam.preview, blobs.LAPLACIAN_15X15, stream_name="laplacian")

# create another neural network node
lp_gray, xout_lp_gray = create_neural_network(pipeline, lp.passthrough, blobs.LAPLACIAN_GRAY_15X15, stream_name="laplacian_gray")
