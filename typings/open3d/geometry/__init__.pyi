...
class LineSet(Geometry3D):
    ...
    @overload
    @classmethod
    def create_camera_visualization(cls, intrinsic: open3d.cpu.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray[numpy.float64[4,4]], scale: float = ...) -> LineSet: ...
    @classmethod
...
class OrientedBoundingBox(Geometry3D):
    ...
    @classmethod
    def create_from_points(cls, points: open3d.cpu.pybind.utility.Vector3dVector, robust: bool = ...) -> OrientedBoundingBox: ...
    def get_box_points(self) -> Any: ...
    def get_point_indices_within_bounding_box(self, points) -> Any: ...
    def volume(self) -> Any: ...
