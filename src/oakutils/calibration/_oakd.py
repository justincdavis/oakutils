...
def get_oakd_calibration_primary_mono(
    ...
    *,
    ...
    # load the data from get_oakd_calibration
    data: CalibrationData = get_oakd_calibration_basic(
        device=device,
        rgb_size=rgb_size,
        mono_size=mono_size,
    )
    ...
    # return all the data, including from get_oakd_calibration
...
def get_oakd_calibration(
    ...
    *,
    ...
    if is_primary_mono_left is None:
        is_primary_mono_left = True
    # get the data from get_oakd_calibration_primary_mono
    data: CalibrationData = get_oakd_calibration_primary_mono(
        device=device,
        rgb_size=rgb_size,
        mono_size=mono_size,
